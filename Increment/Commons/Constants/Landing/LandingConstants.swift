...
struct LandingConstants {
    static let landingBackgroundImageName = "ropes"
    static let landingTitleText = NSLocalizedString("landing_title_text", comment: "Landing title text")
    static let landingTitleSize: CGFloat = 64
